...
```
Authorization: Bearer pat_<26-char base32>
```

- Token format: `pat_` prefix + 8-char ID + 18-char secret (base32, ~130 bits entropy).
- Scheme name is case-insensitive (`bearer`, `BEARER` all accepted).
...
# → pat_7K2N4QQ5PHJX9VMRWN8B3CTKZE   (shown ONCE)
