...
`traffik` is not a voodu kind. It is a block the [voodu-traffik](https://github.com/thadeu/voodu-traffik) plugin owns, and voodu knows only that it belongs to a plugin by that name.
